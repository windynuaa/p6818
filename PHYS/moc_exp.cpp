...
const QMetaObject exp::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_exp.data,
      qt_meta_data_exp,  qt_static_metacall, nullptr, nullptr}
};
...
void *exp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_exp.stringdata0))
        return static_cast<void*>(const_cast< exp*>(this));
